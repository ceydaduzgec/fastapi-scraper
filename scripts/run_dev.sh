...
# Launch as: source scripts/run_development.sh from the project's root
...
CONTAINER_UID=$(id -u) CONTAINER_GID=$(id -g) docker-compose -f ${DOCKER_COMPOSE_FILE} exec fastapi_scraper_api bash
